...
local Steal = { AutoStealEnabled=false, StealRadius=55, StealDuration=0.25, Data={} }
...
local function Main()
    ...
    do
        local page = buildPage("Auto Steal", function()
            ...
            setInstaGrab = makeToggleRow("Auto Steal", false, function(on) Steal.AutoStealEnabled=on; if on then startAutoSteal() else stopAutoSteal() end end)
