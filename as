...
local function savePosition(pos)
	...
	pcall(function()
		writefile(POS_FILE, string.format("%.6f,%d,%.6f,%d", xs, xo, ys, yo))
	end)
end
...
local cmdsToSpam={"rocket","morph","inverse","control","ragdoll","balloon","nightvision","jumpscare","jail","tiny"}
